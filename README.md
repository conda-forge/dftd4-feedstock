...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dftd4-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dftd4-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add dftd4 dftd4-devel
# for installing globally
pixi global install dftd4 dftd4-devel
```
...
It is possible to list all of the versions of `dftd4` available on your platform:
...
```
pixi search dftd4 --channel conda-forge
```
